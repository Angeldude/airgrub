...
class ProducesControllerTest < ActionController::TestCase
  ...
  test "should create produce" do
    assert_difference('Produce.count') do
      post :create, produce: { description: @produce.description, name: @produce.name, price_in_cents: @produce.price_in_cents }
    end
  ...
  test "should update produce" do
    patch :update, id: @produce, produce: { description: @produce.description, name: @produce.name, price_in_cents: @produce.price_in_cents }
    assert_redirected_to produce_path(assigns(:produce))
  end
